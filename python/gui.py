...
import open
import check
from arduino_ import look_arduino
wnd = tk.Tk()
...
arduino_button  = tk.Button(wnd, text="arduino",underline=-1,command=look_arduino)
arduino_button.place(relx=0.5,rely=0.9,anchor="center")
